...
public class FetchSentRequest extends SpiceRequest<SentItemsResponse> {
    private Context context;

    public FetchSentRequest(Context context) {
    ...
    public SentItemsResponse loadDataFromNetwork() throws Exception {
        ...
        msc.buildBaseURI("Physician", "GetInAppNotificationSentItems", "GET");
