...
public abstract class AbstractPasscodeKeyboardActivity extends Activity {
    ...
    protected void showPasswordMaxError(){
        Toast toast = Toast.makeText(AbstractPasscodeKeyboardActivity.this,"Max unlock attempts, please re-login", Toast.LENGTH_SHORT);
        toast.setGravity(Gravity.TOP|Gravity.CENTER_HORIZONTAL, 0, 30);
        toast.show();
    }
